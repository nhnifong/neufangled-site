...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image4.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image16.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image33.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image21.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image10.png){ loading=lazy, width=45% }

Cut away the sacreficial bridge from this U-shaped region in the frame.  

![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image15.png){ loading=lazy, width=45% }

### Noise Dampening

Insert four rubber noise dampeners into the four motor screw holes as show, so that the thicker end is pointed outwards.

![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image25.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image32.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image24.png){ loading=lazy, width=45% }

Insert all four M3x10 motors screws in their holes. It’s a bit harder to insert them later, but still possible.

![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image36.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image8.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image12.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image37.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image38.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image39.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image40.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image41.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image28.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image3.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image14.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image19.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image17.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image46.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image47.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image48.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image22.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image27.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image42.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image43.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image44.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image26.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image35.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image9.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image45.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image49.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image23.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image5.png){ loading=lazy, width=45% }

From the back, feed the 4 pin plug to the straight header and connect it with the V+ (red) wire closest to the SD card.

![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image7.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image13.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image34.png){ loading=lazy, width=45% }
...
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/image20.png){ loading=lazy, width=45% }
![](https://bucket-neu-1.s3.us-east-1.amazonaws.com/images/ag/imag11.png){ loading=lazy, width=45% }
